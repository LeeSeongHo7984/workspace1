...
<header class="blog-header py-3">
	...
	<form action="selectCategory" method="post" style="text-align: center; margin-top: 50px;">
	<span style="font-size: 100px; font-weight: bold;">Category</span><br>
	...
	<input type="submit" value="조회" class="btn btn-lg btn-secondary" style="margin-top: 150px; width: 400px;" />
	</form>
