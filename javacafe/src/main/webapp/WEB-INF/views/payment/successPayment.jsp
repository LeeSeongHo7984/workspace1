...
<header class="blog-header py-3">
	...
	<p style="font-size: 80px; text-align: center; margin-top: 184px;">결제가 완료 되었습니다</p><br>
		<button type="button" class="btn-secondary" onClick="location.href='/javacafe/home/homePage'" 
		style="margin-top: 150px;width: 250px;">확인</button>
	
	
	<!-- FOOTER -->
	<footer class="blog-footer" style="transform: translateY(149%);">
