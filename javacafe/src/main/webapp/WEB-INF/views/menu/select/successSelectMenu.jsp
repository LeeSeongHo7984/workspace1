...
<header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
  	...
  	<div style="font-size: 80px; font-weight: bold; text-align: center; margin-top: 100px;">
	<span >결제 하시겠습니까</span><br>
	</div>
	<div style="text-align: center; margin-top: 80px; font-size: 50px; font-weight: bold;">
	<c:forEach var="menu" items="${menuList}">
	<label>메뉴 : ${menu.name}</label><br>
	<label>가격 : ${menu.price}</label><br>
	</c:forEach>
	</div>
	<button type="submit" class="btn-secondary" style="margin-top: 100px;width: 250px;">예</button>
